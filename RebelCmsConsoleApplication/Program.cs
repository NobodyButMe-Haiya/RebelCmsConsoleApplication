...
if (string.IsNullOrEmpty(tableNameDetail))
{
    ...
    try
    {
        ...
        fileStreamModel.Write(Encoding.UTF8.GetBytes(data.Count < 6
            ? codeGenerator.GenerateModel(module, tableName)
        ...
        fileStreamRepository.Write(Encoding.UTF8.GetBytes(data.Count < 6
            ? codeGenerator.GenerateRepository(module, tableName)
...
else
{
    ...
    try
    {
        ...
        fileStreamMasterController.Write(
        ...
        fileStreamDetailController.Write(
            Encoding.UTF8.GetBytes(codeGenerator.GenerateController(module, tableNameDetail)));
        // end controller
        ...
        fileStreamDetailRepository.Write(
            Encoding.UTF8.GetBytes(codeGenerator.GenerateRepository(module, tableNameDetail)));
        ...
        fileStreamPages.Write(
            Encoding.UTF8.GetBytes(codeGenerator.GenerateMasterAndDetail(module, tableName, tableNameDetail)));
